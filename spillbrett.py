    ...
    def legg_til_objekter_fra_fil(self, filnavn):
        ...
        with open(filnavn) as fil:
            for linje in fil:
                i = linje.split()
                type = i[0]
                posisjon_venstre = int(i[1])
                posisjon_topp = int(i[2])
                if type == "sau":
                    self.opprett_sau("sau", posisjon_venstre, posisjon_topp)
                elif type == "ulv":
                    self.opprett_ulv("ulv", posisjon_venstre, posisjon_topp)
                elif type == "gress":
                    self.opprett_gress("gress", posisjon_venstre, posisjon_topp)
                elif type == "stein":
                    self.opprett_stein("stein", posisjon_venstre, posisjon_topp)
                else:
                    print("error")
